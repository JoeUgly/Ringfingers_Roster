...
`--strict`&ensp;&emsp;&emsp;&emsp;&emsp;&emsp;Attempt name extraction only if a prefix and suffix are found. [See Readme](https://github.com/JoeUgly/Dark_Souls_3_Roll_Call/blob/main/README.md#Misinterpreted-characters-in-prefix-or-suffix)\
